...
export const FISCAL_CONFIG_2025 = {
  ...
  simples_nacional: {
    ...
    anexoI: [
        ...
        { min: 1800000.01, max: 360000, rate: 0.143, deduction: 87300, distribution: { IRPJ: 0.055, CSLL: 0.035, COFINS: 0.1274, PIS: 0.0276, CPP: 0.42, ICMS: 0.335 } },
    ...
    anexoIII: [
        ...
        { min: 1800000.01, max: 360000, rate: 0.21, deduction: 125640, distribution: { IRPJ: 0.04, CSLL: 0.04, COFINS: 0.1356, PIS: 0.0294, CPP: 0.445, ISS: 0.310 } },
    ...
    anexoIV: [
        ...
        { min: 1800000.01, max: 360000, rate: 0.22, deduction: 183780, distribution: { IRPJ: 0.188, CSLL: 0.192, COFINS: 0.2243, PIS: 0.0457, ISS: 0.35 } },
    ...
    anexoV: [
        ...
        { min: 1800000.01, max: 360000, rate: 0.23, deduction: 62100, distribution: { IRPJ: 0.17, CSLL: 0.15, COFINS: 0.1737, PIS: 0.0378, CPP: 0.3185, ISS: 0.15 } },
