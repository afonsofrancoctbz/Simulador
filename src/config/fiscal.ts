...
export const FISCAL_CONFIG_2025 = {
  ...
  simples_nacional: {
    ...
    anexoII: [
        ...
        { min: 1800000.01, max: 360000, rate: 0.147, deduction: 85500, distribution: { IRPJ: 0.055, CSLL: 0.035, COFINS: 0.1274, PIS: 0.0276, CPP: 0.375, ICMS: 0.3, IPI: 0.075 } },
    ...
    anexoIII: [
        ...
        { min: 180000.01, max: 360000, rate: 0.112, deduction: 9360, distribution: { IRPJ: 0.04, CSLL: 0.035, COFINS: 0.1405, PIS: 0.0305, CPP: 0.434, ISS: 0.315 } },
        { min: 360000.01, max: 720000, rate: 0.135, deduction: 17640, distribution: { IRPJ: 0.04, CSLL: 0.035, COFINS: 0.136, PIS: 0.0295, CPP: 0.44, ISS: 0.32 } },
        { min: 720000.01, max: 1800000, rate: 0.16, deduction: 35640, distribution: { IRPJ: 0.04, CSLL: 0.04, COFINS: 0.14, PIS: 0.03, CPP: 0.44, ISS: 0.31 } },
        { min: 1800000.01, max: 3600000, rate: 0.21, deduction: 125640, distribution: { IRPJ: 0.04, CSLL: 0.04, COFINS: 0.135, PIS: 0.029, CPP: 0.445, ISS: 0.31 } },
        { min: 3600000.01, max: 4800000, rate: 0.33, deduction: 648000, distribution: { IRPJ: 0.35, CSLL: 0.15, COFINS: 0.16, PIS: 0.035, CPP: 0.305, ISS: 0 } },
    ],
    anexoIV: [
    ...
    anexoV: [
        ...
        { min: 3600000.01, max: 4800000, rate: 0.30, deduction: 270000, distribution: { IRPJ: 0.235, CSLL: 0.155, COFINS: 0.281, PIS: 0.024, CPP: 0.305, ISS: 0 } },
    ],
  }
};
