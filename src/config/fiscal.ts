  ...
  tabela_inss_clt_progressiva: [
   ...
   reforma_renda_2026: {
    ...
    tabela_irrf: [
        ...
        { min: 5000.01, max: 5500.00, rate: 0.075, deduction: 375 }, // Alíquota efetiva de 7.5% sobre o excedente de 5k
   ...
   get tabela_irrf() {
    return this.reforma_renda_2026.tabela_irrf;
  },
};
