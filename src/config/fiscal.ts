...
export const FISCAL_CONFIG_2026 = {
    ...
    ano_vigencia: 2026,
    reforma_tributaria: {
        // Alíquotas de teste, PIS/COFINS/ISS ainda existem para LP
        cbs_rate_test: 0.009, 
        ibs_rate_test: 0.001, 
        // No LP, esses impostos são somados aos antigos. No SN, não se aplicam.
        iva_rate: 26.5/100,
    }
};
...
export const FISCAL_CONFIG_2027_2028 = {
    ...
    simples_nacional: {
        limite_fator_r: 0.28,
         I: [
            { min: 0, max: 180000, rate: 0.04, deduction: 0, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1533, CPP: 0.415, ICMS: 0.34, IBS: 0.0017 } },
            { min: 180000.01, max: 360000, rate: 0.073, deduction: 5940, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1533, CPP: 0.415, ICMS: 0.34, IBS: 0.0017 } },
            { min: 360000.01, max: 720000, rate: 0.095, deduction: 13860, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1533, CPP: 0.42, ICMS: 0.335, IBS: 0.0017 } },
            { min: 720000.01, max: 1800000, rate: 0.107, deduction: 22500, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1533, CPP: 0.42, ICMS: 0.335, IBS: 0.0017 } },
            { min: 1800000.01, max: 3600000, rate: 0.143, deduction: 87300, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1533, CPP: 0.42, ICMS: 0.335, IBS: 0.0017 } },
        ...
        II: [
            { min: 0, max: 180000, rate: 0.045, deduction: 0, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1385, CPP: 0.375, ICMS: 0.32, IPI: 0.075, IBS: 0.0015 } },
            { min: 180000.01, max: 360000, rate: 0.078, deduction: 5940, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1385, CPP: 0.375, ICMS: 0.32, IPI: 0.075, IBS: 0.0015 } },
            { min: 360000.01, max: 720000, rate: 0.10, deduction: 13860, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1385, CPP: 0.375, ICMS: 0.32, IPI: 0.075, IBS: 0.0015 } },
            { min: 720000.01, max: 1800000, rate: 0.112, deduction: 22500, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1385, CPP: 0.375, ICMS: 0.32, IPI: 0.075, IBS: 0.0015 } },
            { min: 1800000.01, max: 3600000, rate: 0.147, deduction: 85500, distribution: { IRPJ: 0.055, CSLL: 0.035, CBS: 0.1385, CPP: 0.375, ICMS: 0.32, IPI: 0.075, IBS: 0.0015 } },
        ...
        III: [
          ...
          { min: 180000.01, max: 360000, rate: 0.112, deduction: 9360, distribution: { IRPJ: 0.04, CSLL: 0.035, CBS: 0.1691, CPP: 0.434, ISS: 0.32, IBS: 0.0019 } },
          ...
          { min: 1800000.01, max: 3600000, rate: 0.21, deduction: 125640, distribution: { IRPJ: 0.04, CSLL: 0.04, CBS: 0.1543, CPP: 0.434, ISS: 0.335, IBS: 0.0017 } },
        ...
        IV: [
            { min: 0, max: 180000, rate: 0.045, deduction: 0, distribution: { IRPJ: 0.188, CSLL: 0.152, CBS: 0.2126, CPP: 0, ISS: 0.445, IBS: 0.0024 } },
            { min: 180000.01, max: 360000, rate: 0.09, deduction: 8100, distribution: { IRPJ: 0.198, CSLL: 0.152, CBS: 0.2473, CPP: 0, ISS: 0.40, IBS: 0.0027 } },
            { min: 360000.01, max: 720000, rate: 0.102, deduction: 12420, distribution: { IRPJ: 0.208, CSLL: 0.152, CBS: 0.2374, CPP: 0, ISS: 0.40, IBS: 0.0026 } },
            { min: 720000.01, max: 1800000, rate: 0.14, deduction: 39780, distribution: { IRPJ: 0.178, CSLL: 0.192, CBS: 0.2275, CPP: 0, ISS: 0.40, IBS: 0.0025 } },
            { min: 1800000.01, max: 3600000, rate: 0.22, deduction: 183780, distribution: { IRPJ: 0.188, CSLL: 0.192, CBS: 0.2176, CPP: 0, ISS: 0.40, IBS: 0.0024 } },
            { min: 3600000.01, max: 4800000, rate: 0.329, deduction: 828000, distribution: { IRPJ: 0.5371, CSLL: 0.2159, CBS: 0.247, CPP: 0, IBS: 0, ISS: 0 } },
        ],
        V: [
          { min: 0, max: 180000, rate: 0.155, deduction: 0, distribution: { IRPJ: 0.25, CSLL: 0.15, CBS: 0.1696, CPP: 0.2885, ISS: 0.14, IBS: 0.0019 } },
          { min: 180000.01, max: 360000, rate: 0.18, deduction: 4500, distribution: { IRPJ: 0.23, CSLL: 0.15, CBS: 0.1696, CPP: 0.2785, ISS: 0.17, IBS: 0.0019 } },
          { min: 360000.01, max: 720000, rate: 0.195, deduction: 9900, distribution: { IRPJ: 0.24, CSLL: 0.15, CBS: 0.1795, CPP: 0.2385, ISS: 0.19, IBS: 0.0020 } },
          { min: 720000.01, max: 1800000, rate: 0.205, deduction: 17100, distribution: { IRPJ: 0.21, CSLL: 0.15, CBS: 0.1894, CPP: 0.2385, ISS: 0.21, IBS: 0.0021 } },
          { min: 1800000.01, max: 3600000, rate: 0.23, deduction: 62100, distribution: { IRPJ: 0.23, CSLL: 0.125, CBS: 0.1696, CPP: 0.2385, ISS: 0.235, IBS: 0.0019 } },
 ...
 */
export const getFiscalParameters = (year: number): FiscalConfig | FiscalConfig2026 => {
    if (year <= 2025) {
