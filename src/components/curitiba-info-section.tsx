...
export default function CuritibaInfoSection() {
  return (
      ...
      <Card className="shadow-xl border-primary/20 bg-primary/5">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">
            Informações para Abrir sua Empresa em Curitiba - PR
          </CardTitle>
          <CardDescription className="text-md mt-2 text-muted-foreground">
            Tudo o que você precisa saber para começar com o pé direito na capital paranaense.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Accordion type="single" collapsible className="w-full text-left">
            ...
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>
                  Na Contabilizei, <strong>não cobramos honorários para a abertura do seu CNPJ</strong>. Você contrata o plano de contabilidade e arca apenas com as taxas dos órgãos públicos. Para <strong>Curitiba - PR</strong>, os custos iniciais são:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Taxa da Junta Comercial (JUCEPAR):</strong> <Badge variant="secondary">R$ 128,30</Badge> para sociedades (LTDA/SLU) ou <Badge variant="secondary">R$ 92,40</Badge> para Empresário Individual (EI). Esta taxa é paga apenas uma vez.</li>
                  <li><strong>Taxa de Alvará (Prefeitura):</strong> A partir de <Badge variant="secondary">R$ 323,86</Badge>.</li>
                </ul>
                <div className="p-3 border-l-4 border-green-500 bg-green-50/80 text-green-900 rounded-r-md">
                    ...
                    <p className="mt-1">
                        Curitiba participa da nossa campanha de <strong>Custo Zero</strong>! Isso significa que <strong>isentamos você da taxa da Junta Comercial</strong>, uma economia e tanto para começar.
                    </p>
                </div>
                 ...
                 <p className="text-sm">
                  <strong>Atenção:</strong> Empresas enquadradas como ME (Microempresa) são isentas da Taxa de Alvará em Curitiba.
                </p>
              </AccordionContent>
            </AccordionItem>
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>O processo é ágil e digital:</p>
                 <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>A emissão de notas fiscais poderá acontecer após o enquadramento da empresa no regime tributário, com um prazo total de aproximadamente <strong>22 dias corridos</strong>.</li>
                </ul>
              </AccordionContent>
            </AccordionItem>
          ...
          <Alert variant="default" className="mt-8 bg-amber-50/80 border-amber-200 text-amber-900">
            ...
            <AlertDescription className="space-y-2">
                <p>Este simulador contempla apenas os valores iniciais da taxa de alvará municipal. Dependendo da sua atividade e município, podem incidir taxas adicionais. O custo zero incide apenas sobre o valor da taxa da junta comercial.</p>
                <ul className="list-disc pl-5 text-sm">
                    <li><strong>Taxa de Bombeiros:</strong> Cobrada para empresas em endereços comerciais, variando de R$ 90,00 a R$ 200,00.</li>
                    <li><strong>Vigilância Sanitária:</strong> Exigida para atividades de saúde ou comércio de alimentos, com valores entre R$ 90,00 e R$ 200,00.</li>
                </ul>
            </AlertDescription>
          </Alert>
        </CardContent>
