...
export default function GoianiaInfoSection() {
  return (
      ...
      <Card className="shadow-xl border-primary/20 bg-primary/5">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">
            Informações para Abrir sua Empresa em Goiânia - GO
          </CardTitle>
          <CardDescription className="text-md mt-2 text-muted-foreground">
            Tudo o que você precisa saber para começar seu negócio na capital goiana.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Accordion type="single" collapsible className="w-full text-left">
            ...
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>
                  Na Contabilizei, <strong>não cobramos honorários para a abertura do seu CNPJ</strong>. Você contrata o plano de contabilidade e arca apenas com as taxas dos órgãos públicos. Para <strong>Goiânia - GO</strong>, os custos iniciais são:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Taxa da Junta Comercial (JUCEG):</strong> <Badge variant="secondary">R$ 338,00</Badge> para sociedades (LTDA/SLU) ou <Badge variant="secondary">R$ 202,00</Badge> para Empresário Individual (EI). Esta taxa é paga apenas uma vez.</li>
                  <li><strong>Taxa de Alvará (Prefeitura):</strong> A partir de <Badge variant="secondary">R$ 998,43</Badge>.</li>
                </ul>
                ...
                <p className="text-sm">
                  <strong>Taxa de Fiscalização de Estabelecimentos (TFE):</strong> Em Goiânia, este é um tributo municipal cobrado anualmente em decorrência das atividades de fiscalização.
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>O processo na capital goiana segue os seguintes prazos:</p>
                 <ul className="list-disc pl-6 space-y-2">
                  <li>O prazo para obtenção do <strong>CNPJ é de aproximadamente 9 dias corridos</strong>.</li>
                  <li>A emissão de notas fiscais poderá acontecer após o enquadramento da empresa no regime tributário, com um prazo total de aproximadamente <strong>50 dias corridos</strong>.</li>
                </ul>
              </AccordionContent>
            </AccordionItem>
