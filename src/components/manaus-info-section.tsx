...
export default function ManausInfoSection() {
  return (
      ...
      <Card className="shadow-xl border-primary/20 bg-primary/5">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">
            Informações para Abrir sua Empresa em Manaus - AM
          </CardTitle>
          <CardDescription className="text-md mt-2 text-muted-foreground">
            Tudo o que você precisa saber para começar seu negócio na capital do Amazonas.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Accordion type="single" collapsible className="w-full text-left">
            ...
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>
                  Na Contabilizei, <strong>não cobramos honorários para a abertura do seu CNPJ</strong>. Você contrata o plano de contabilidade e arca apenas com as taxas dos órgãos públicos. Para <strong>Manaus - AM</strong>, os custos iniciais são:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Taxa da Junta Comercial (JUCEA):</strong> <Badge variant="secondary">R$ 571,42</Badge> para sociedades (LTDA/SLU). Esta taxa é paga apenas uma vez.</li>
                  <li><strong>Taxa de Alvará (Prefeitura):</strong> A partir de <Badge variant="secondary">R$ 192,95</Badge>.</li>
                </ul>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>O processo em Manaus segue os seguintes prazos:</p>
                 <ul className="list-disc pl-6 space-y-2">
                  <li>O prazo para obtenção do <strong>CNPJ é de aproximadamente 12 dias corridos</strong>.</li>
                  <li>A emissão de notas fiscais poderá acontecer após o enquadramento da empresa no regime tributário, com um prazo total de aproximadamente <strong>45 dias corridos</strong>.</li>
                </ul>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                ...
                <div className="p-3 mt-4 border-l-4 border-sky-500 bg-sky-50/80 text-sky-900 rounded-r-md">
                    ...
                    <p className="mt-1">
                      Você consegue emitir as Notas Fiscais no site da prefeitura da sua cidade ou nos emissores gratuitos encontrados na Internet. Uma vez por mês você vai registrar os dados das notas fiscais no nosso sistema e também por lá, vai importar o seu extrato bancário da conta PJ em formato OFX (formato do banco).
                    </p>
                </div>
