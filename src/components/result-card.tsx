    ...
    return (
        <Card className={cn(
            ...
            <CardHeader className={cn(
                ...
                <CardTitle className="text-lg font-bold text-foreground">{details.regime}</CardTitle>
                {details.annex && <CardDescription className='font-semibold text-primary/90 text-sm'>{details.annex}</CardDescription>}
            </CardHeader>

            <CardContent className="flex-grow p-3 space-y-2 flex flex-col">
                
                <div className="p-2 border rounded-md bg-background/80 space-y-1 text-xs">
                ...
                <div className="space-y-2">
                     <div className="p-2 border rounded-md bg-background/80 space-y-1.5 text-xs">
                 ...
                 {details.fatorR !== undefined && (
                    <div className={cn(
                        "text-center rounded-md p-1.5 text-xs", 
                        details.fatorR >= 0.28 
                 ...
                 {details.optimizationNote && (
                    <div className="p-2 rounded-lg bg-emerald-50 text-emerald-900 border border-emerald-200 text-xs flex items-start gap-2">
            ...
            <CardFooter className="p-2 bg-muted/30 mt-auto border-t">
                <div className="text-center w-full space-y-0.5">
                    <div className="text-xs text-muted-foreground">Custo Total Mensal Estimado</div>
