...
export default function BeloHorizonteInfoSection() {
  return (
      ...
      <Card className="shadow-xl border-primary/20 bg-primary/5">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">
            Informações para Abrir sua Empresa em Belo Horizonte - MG
          </CardTitle>
          <CardDescription className="text-md mt-2 text-muted-foreground">
            Tudo o que você precisa saber para começar seu negócio na capital mineira.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Accordion type="single" collapsible className="w-full text-left">
            ...
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>
                  Na Contabilizei, <strong>não cobramos honorários para a abertura do seu CNPJ</strong>. Você contrata o plano de contabilidade e arca apenas com as taxas dos órgãos públicos. Para <strong>Belo Horizonte - MG</strong>, os custos iniciais são:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Taxa de Alvará (Prefeitura):</strong> A partir de <Badge variant="secondary">R$ 154,10</Badge>.</li>
                </ul>
                <div className="p-3 border-l-4 border-green-500 bg-green-50/80 text-green-900 rounded-r-md">
                    ...
                    <p className="mt-1">
                        Belo Horizonte participa da nossa campanha de <strong>Custo Zero</strong>! Isso significa que <strong>isentamos você da taxa da Junta Comercial</strong>, uma economia e tanto para começar.
                    </p>
                </div>
                 ...
                 <p className="text-sm">
                  <strong>Taxa de Fiscalização de Estabelecimentos (TFE):</strong> Em Belo Horizonte, este é um tributo municipal cobrado anualmente em decorrência das atividades de fiscalização.
                </p>
              </AccordionContent>
            </AccordionItem>
