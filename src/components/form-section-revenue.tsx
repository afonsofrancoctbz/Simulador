...
export function FormSectionRevenue() {
        ...
        <Card className='shadow-lg overflow-hidden border bg-card'>
            <CardHeader className='border-b bg-muted/30'>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <CardTitle className="text-xl font-bold">Receita Anual (RBT12)</CardTitle>
            ...
            <CardContent className='p-6 md:p-8'>
                <FormField control={form.control} name="rbt12" render={({ field }) => {
                    ...
                    return (
                        <FormItem>
                            <FormLabel>Faturamento Total dos Últimos 12 Meses</FormLabel>
                            ...
                            <FormDescription>
                                Se for uma nova empresa, pode deixar em R$ 0,00. O sistema usará o faturamento mensal informado para projetar a receita.
                            </FormDescription>
                            <FormMessage />
                            {showSimplesLimitWarning && (
                                <Alert variant="destructive" className="mt-2">
                                    ...
                                    <AlertDescription>
                                        Sua receita anual projetada ({formatCurrencyBRL(projectedAnnualRevenue)}) ultrapassa o teto de R$ 4,8 milhões. O Simples Nacional não será uma opção viável.
                                    </AlertDescription>
                                </Alert>
                            )}
                        </FormItem>
