...
export default function SalvadorInfoSection() {
  return (
      ...
      <Card className="shadow-xl border-primary/20 bg-primary/5">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">
            Informações para Abrir sua Empresa em Salvador - BA
          </CardTitle>
          <CardDescription className="text-md mt-2 text-muted-foreground">
            Tudo o que você precisa saber para começar seu negócio na primeira capital do Brasil.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Accordion type="single" collapsible className="w-full text-left">
            ...
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>
                  Na Contabilizei, <strong>não cobramos honorários para a abertura do seu CNPJ</strong>. Você contrata o plano de contabilidade e arca apenas com as taxas dos órgãos públicos. Para <strong>Salvador - BA</strong>, os custos iniciais são:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Taxa da Junta Comercial (JUCEB):</strong> <Badge variant="secondary">R$ 349,00</Badge> para sociedades (LTDA/SLU) ou <Badge variant="secondary">R$ 151,00</Badge> para Empresário Individual (EI). Esta taxa é paga apenas uma vez.</li>
                  <li><strong>Taxa de Alvará (Prefeitura - TVL):</strong> A partir de <Badge variant="secondary">R$ 1.345,27</Badge>.</li>
                </ul>
                ...
                <p className="text-sm">
                  <strong>Taxa de Fiscalização de Estabelecimentos (TFF):</strong> Em Salvador, este é um tributo municipal cobrado anualmente em decorrência das atividades de fiscalização.
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>O processo em Salvador segue os seguintes prazos:</p>
                 <ul className="list-disc pl-6 space-y-2">
                  <li>O prazo para obtenção do <strong>CNPJ é de aproximadamente 10 dias corridos</strong>.</li>
                  <li>A emissão de notas fiscais poderá acontecer após o enquadramento da empresa no regime tributário, com um prazo total de aproximadamente <strong>37 dias corridos</strong>.</li>
                </ul>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="space-y-4 pt-2 text-base text-muted-foreground">
                <p>
                  Depois que sua empresa estiver aberta, cuidamos de toda a rotina contábil para você focar no seu negócio. Nossos serviços incluem:
                </p>
                 <ul className="list-disc pl-6 space-y-2">
                 ...
                 <div className="p-3 mt-4 border-l-4 border-sky-500 bg-sky-50/80 text-sky-900 rounded-r-md">
                    ...
                    <p className="mt-1">
                     Você consegue emitir as Notas Fiscais no site da prefeitura da sua cidade ou nos emissores gratuitos encontrados na Internet. Uma vez por mês, você registra os dados das notas fiscais em nosso sistema.
                    </p>
                </div>
              </AccordionContent>
            </AccordionItem>
