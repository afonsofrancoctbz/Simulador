...
// This is a comprehensive list of CNAEs based on common business activities and their tax classifications.
// The information regarding Annex and Fator R is based on the rules of the Simples Nacional tax regime.
export const CNAE_DATA: CnaeData[] = [
  ...
  { code: '8610-1/01', description: 'Atividades de atendimento hospitalar, exceto pronto socorro e urgências', annex: 'III', presumedProfitRate: 0.32 },
  ...
  // === SERVIÇOS - ANEXO IV ===
  // (Construção, Limpeza, Vigilância, Advocacia)
  ...
  { code: '6920-6/02', description: 'Atividades de consultoria e auditoria contábil e tributária', annex: 'V', requiresFatorR: true, presumedProfitRate: 0.32 },
