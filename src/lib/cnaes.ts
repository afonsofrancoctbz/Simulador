...
export const CNAE_DATA: CnaeData[] = [
  ...
  { code: '6911-7/01', description: 'Serviços advocatícios (Consultoria Jurídica)', annex: 'IV', presumedProfitRate: 0.32 },
  ...
  { code: '6201-5/01', description: 'Desenvolvimento de programas de computador sob encomenda (inclui web design)', annex: 'V', requiresFatorR: true, presumedProfitRate: 0.32 },
