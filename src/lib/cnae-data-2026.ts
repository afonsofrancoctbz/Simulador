...
// Baseado na lista detalhada de CNAE x NBS x Reduções de IBS/CBS.
...
/**
 * Classes Tributárias baseadas nos percentuais de redução da Reforma.
 * A chave (cClass) identifica o grupo de alíquota.
 */
export const CNAE_CLASSES_2026: CnaeClass2026[] = [
    ...
    { cClass: '060_SAUDE',  description: 'Saúde, Educação, Transportes, Software (60% Redução)', ibsReduction: 60, cbsReduction: 60 },
    ...
    // Classes Especiais/Híbridas (caso existam exceções na lei onde IBS != CBS, mantemos compatibilidade)
 ...
 * Contém todas as variações de alíquotas para garantir precisão no cálculo.
 */
export const CNAE_LC116_RELATIONSHIP: CnaeRelationship2026[] = [
    ...
    // --- CNAE 1830003 ---
    { itemLC116: '01.03', descriptionLC116: 'Hospedagem de Sites', nationalCode: '000000', cnae: '1830003', nbs: '1.1506.10.00', nbsDescription: 'Serviços de hospedagem de sítios eletrônicos na rede mundial de computadores', cClassTrib: '000_PADRAO' },

    // --- CNAE 3250706 ---
    { itemLC116: '04.01', descriptionLC116: 'Saúde', nationalCode: '000000', cnae: '3250706', nbs: '1.2301.99.00', nbsDescription: 'Outros serviços de saúde humana não classificados em subposições anteriores (Prótese)', cClassTrib: '060_SAUDE' },
    ...
    // --- CNAE 4211101 (Construção de Rodovias) ---
    // Nota: Possui entradas duplicadas de NBS com alíquotas diferentes (50% e 60%), mantidas conforme fonte para seleção de regime.
    ...
    // --- CNAE 5590699 (Outros Alojamentos) ---
    ...
    { itemLC116: '01.05', descriptionLC116: 'Licenciamento', nationalCode: '000000', cnae: '6190601', nbs: '1.1103.29.00', nbsDescription: 'Licenciamento de direitos sobre programas de computador (software) e bancos de dados', cClassTrib: '000_PADRAO' },

    // --- CNAE 6201501 ---
    { itemLC116: '01.01', descriptionLC116: 'Desenvolvimento', nationalCode: '000000', cnae: '6201501', nbs: '1.1502.10.00', nbsDescription: 'Serviços de projeto e desenvolvimento de aplicativos e programas (Software Encomenda)', cClassTrib: '000_PADRAO' },
    { itemLC116: '01.01', descriptionLC116: 'Desenvolvimento', nationalCode: '000000', cnae: '6201501', nbs: '1.1502.20.00', nbsDescription: 'Serviços de projeto e desenvolvimento de aplicativos e programas (TI)', cClassTrib: '000_PADRAO' },
    ...
    // --- CNAE 6202300 ---
    { itemLC116: '01.01', descriptionLC116: 'Desenvolvimento', nationalCode: '000000', cnae: '6202300', nbs: '1.1502.10.00', nbsDescription: 'Serviços de projeto e desenvolvimento de aplicativos e programas (TI)', cClassTrib: '000_PADRAO' },
    { itemLC116: '01.01', descriptionLC116: 'Desenvolvimento', nationalCode: '000000', cnae: '6202300', nbs: '1.1502.20.00', nbsDescription: 'Serviços de projeto e desenvolvimento de aplicativos e programas (TI)', cClassTrib: '000_PADRAO' },
    ...
    { itemLC116: '01.05', descriptionLC116: 'Licenciamento', nationalCode: '000000', cnae: '6202300', nbs: '1.1103.29.00', nbsDescription: 'Licenciamento de direitos sobre programas de computador (software)', cClassTrib: '000_PADRAO' },
    ...
    // --- CNAE 6203100 ---
    { itemLC116: '01.01', descriptionLC116: 'Desenvolvimento', nationalCode: '000000', cnae: '6203100', nbs: '1.1502.10.00', nbsDescription: 'Serviços de projeto e desenvolvimento de aplicativos e programas (TI)', cClassTrib: '000_PADRAO' },
    ...
    { itemLC116: '01.05', descriptionLC116: 'Licenciamento', nationalCode: '000000', cnae: '6203100', nbs: '1.1103.29.00', nbsDescription: 'Licenciamento de direitos sobre programas de computador (software)', cClassTrib: '000_PADRAO' },

    // --- CNAE 6204000 (Consultoria TI) ---
    { itemLC116: '01.01', descriptionLC116: 'Consultoria TI', nationalCode: '000000', cnae: '6204000', nbs: '1.1502.10.00', nbsDescription: 'Serviços de projeto e desenvolvimento de aplicativos e programas (TI)', cClassTrib: '000_PADRAO' },
    { itemLC116: '01.06', descriptionLC116: 'Gerenciamento TI', nationalCode: '000000', cnae: '6204000', nbs: '1.1507.10.00', nbsDescription: 'Serviços de gerenciamento de redes em tecnologia da informação (TI)', cClassTrib: '000_PADRAO' },
    ...
    { itemLC116: '01.01', descriptionLC116: 'Consultoria TI', nationalCode: '000000', cnae: '6204000', nbs: '1.1502.90.05', nbsDescription: 'Serviços de TI especializados', cClassTrib: '060_SAUDE' }, // 60%
    ...
    { itemLC116: '01.01', descriptionLC116: 'Consultoria TI', nationalCode: '000000', cnae: '6204000', nbs: '1.1510.00.00', nbsDescription: 'Outros serviços de TI', cClassTrib: '060_SAUDE' }, // 60%
    ...
    { itemLC116: '01.05', descriptionLC116: 'Licenciamento', nationalCode: '000000', cnae: '6311900', nbs: '1.1103.29.00', nbsDescription: 'Licenciamento de direitos sobre programas de computador (software)', cClassTrib: '000_PADRAO' },
    ...
    // --- CNAE 6622300 ---
    { itemLC116: '10.01', descriptionLC116: 'Corretagem', nationalCode: '000000', cnae: '6622300', nbs: '1.0906.11.00', nbsDescription: 'Serviços de agenciamento e corretagem de seguros, resseguros e previdência', cClassTrib: '000_PADRAO' },
    { itemLC116: '10.01', descriptionLC116: 'Corretagem', nationalCode: '000000', cnae: '6622300', nbs: '1.0906.12.00', nbsDescription: 'Serviços de corretagem de seguros saúde', cClassTrib: '060_SAUDE' },
    { itemLC116: '10.01', descriptionLC116: 'Corretagem', nationalCode: '000000', cnae: '6622300', nbs: '1.0910.20.00', nbsDescription: 'Serviços de corretagem de planos privados de assistência à saúde', cClassTrib: '060_SAUDE' },

    // --- CNAE 6629100 ---
    { itemLC116: '04.23', descriptionLC116: 'Planos Saúde', nationalCode: '000000', cnae: '6629100', nbs: '1.0910.90.00', nbsDescription: 'Serviços de planos privados de assistência à saúde e relacionados n.e.', cClassTrib: '060_SAUDE' },

    // --- CNAE 6822600 (Imobiliárias) ---
    ...
    // --- CNAE 7020400 (Consultoria Gestão) ---
    ...
    // --- CNAE 7320300 (Pesquisa de Mercado) ---
    ...
    // --- CNAE 7912100 (Operadores Turísticos) - Repetição da lista acima conforme regra ---
    ...
    // Nota: Mantém-se o mesmo padrão de redução para os 23 NBS do CNAE 7911200

    // --- CNAE 7990200 (Outros serviços turismo) ---
