...
export const CNAE_CLASSES_2026: CnaeClass2026[] = [
    ...
    { cClass: '000002', description: 'Exploração de via', ibsReduction: 0, cbsReduction: 0 },
    { cClass: '000003', description: 'Regime automotivo - projetos incentivados (art. 311)', ibsReduction: 0, cbsReduction: 0 },
    { cClass: '000004', description: 'Regime automotivo - projetos incentivados (art. 312)', ibsReduction: 0, cbsReduction: 0 },
    { cClass: '010001', description: 'Tributação com alíquotas uniformes', ibsReduction: 0, cbsReduction: 0 },
    { cClass: '010002', description: 'Operações do serviço financeiro', ibsReduction: 0, cbsReduction: 0 },
    { cClass: '011001', description: 'Tributação com alíquotas uniformes reduzidas', ibsReduction: 60, cbsReduction: 60 },
    { cClass: '011002', description: 'Planos de assistência à saúde', ibsReduction: 60, cbsReduction: 60 },
    { cClass: '011003', description: 'Intermediação de planos de assistência à saúde', ibsReduction: 60, cbsReduction: 60 },
    { cClass: '011004', description: 'Concursos e prognósticos', ibsReduction: 0, cbsReduction: 0 },
    { cClass: '011005', description: 'Planos de assistência à saúde de animais domésticos', ibsReduction: 30, cbsReduction: 30 },
    { cClass: '200001', description: 'Aquisições realizadas entre empresas autorizadas a operar em zonas de processamento de exportação', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200002', description: 'Fornecimento ou importação para produtor rural não contribuinte ou TAC', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200003', description: 'Vendas de produtos destinados à alimentação humana (Anexo I)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200004', description: 'Venda de dispositivos médicos (Anexo XII)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200005', description: 'Venda de dispositivos médicos adquiridos por órgãos da administração pública (Anexo IV)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200006', description: 'Situação de emergência de saúde pública reconhecida pelo Poder público (Anexo XII)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200007', description: 'Fornecimento dos dispositivos de acessibilidade próprios para pessoas com deficiência (Anexo XIII)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200008', description: 'Fornecimento dos dispositivos de acessibilidade próprios para pessoas com deficiência adquiridos por órgãos da administração pública (Anexo V)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200009', description: 'Fornecimento de medicamentos (Anexo XIV)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200010', description: 'Fornecimento dos medicamentos registrados na Anvisa, adquiridos por órgãos da administração pública', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200011', description: 'Fornecimento das composições para nutrição enteral e parenteral quando adquiridas por órgãos da administração pública (Anexo VI)', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200012', description: 'Situação de emergência de saúde pública reconhecida pelo Poder público (Anexo XIV)', ibsReduction: 100, cbsReduction: 100 },
    ...
    { cClass: '200020', description: 'Operação praticada por sociedades cooperativas optantes por regime específico do IBS e CBS', ibsReduction: 100, cbsReduction: 100 },
    { cClass: '200021', description: 'Serviços de transporte público coletivo de passageiros ferroviário e hidroviário', ibsReduction: 100, cbsReduction: 100 },
    ...
    { cClass: '550004', description: 'Regimes de Depósito (art. 87)', ibsReduction: 0, cbsReduction: 0 },
...
export const CNAE_LC116_RELATIONSHIP: CnaeRelationship2026[] = [
    ...
    { itemLC116: '02.01', descriptionLC116: 'Serviços de pesquisas e desenvolvimento de qualquer natureza.', nationalCode: '020101', cnae: '7210000', nbs: '1.1201.11.00', nbsDescription: 'Serviços de pesquisa e desenvolvimento em ciências físicas', cClassTrib: '200016' },
    ...
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.10.00', nbsDescription: 'Serviços de consultoria em engenharia', cClassTrib: '200038' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.21.10', nbsDescription: 'Serviços de engenharia para projetos de construção residencial', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.21.20', nbsDescription: 'Serviços de engenharia para projetos de construção não residencial', cClassTrib: '200052' },
    ...
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.22.12', nbsDescription: 'Serviços de engenharia para projetos de exploração de petróleo e gás', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.22.13', nbsDescription: 'Serviços de engenharia para projetos de refino de petróleo e petroquímica', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.22.14', nbsDescription: 'Serviços de engenharia para projetos de unidades de produção de biocombustíveis', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.22.21', nbsDescription: 'Serviços de engenharia para projetos de veículos terrestres', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.22.22', nbsDescription: 'Serviços de engenharia para projetos de embarcações', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.22.23', nbsDescription: 'Serviços de engenharia para projetos de veículos aéreos e aeroespaciais', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.22.90', nbsDescription: 'Serviços de engenharia para outros projetos industriais e de fabricação, exceto para projetos de energia', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.23.00', nbsDescription: 'Serviços de engenharia para projetos de infraestrutura de transportes', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.24.00', nbsDescription: 'Serviços de engenharia para projetos de energia', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.25.00', nbsDescription: 'Serviços de engenharia para projetos de telecomunicações, radiodifusão e televisão', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.26.00', nbsDescription: 'Serviços de engenharia para projetos de gerenciamento de resíduos (perigosos e não perigosos)', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.27.00', nbsDescription: 'Serviços de engenharia para projetos de distribuição de água e rede de esgoto', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.29.00', nbsDescription: 'Serviços de engenharia para outros projetos', cClassTrib: '200038' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.30.00', nbsDescription: 'Serviços de gerenciamento de projetos de construção ', cClassTrib: '200052' },
    { itemLC116: '07.01', descriptionLC116: 'Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.', nationalCode: '070101', cnae: '7112000', nbs: '1.1403.90.00', nbsDescription: 'Serviços de engenharia não classificados em subposições anteriores', cClassTrib: '200052' },
